...
const EditPage = () => {
    ...
    const handleUpate = async (e) => {
        e.preventDefault()
        const formData = {
            profile: profilePic ? profilePic : data.profile,
            ...data
        }
        try {
            await apiRequest.put(`/users/${id}`, formData)
    ...
    return (
        <form className='w-[50%] m-auto my-20' onSubmit={handleUpate}>
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button type="button" className="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-red:outline-indigo-600">
                    Delete Account
                </button>
            </div>
        </form>
